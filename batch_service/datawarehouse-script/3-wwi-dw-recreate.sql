...
(
    NAME = WWI_Primary,
    FILENAME = '/var/opt/mssql/data/WideWorldImportersDW.mdf',
    SIZE = 2GB,
    MAXSIZE = UNLIMITED,
    FILEGROWTH = 64MB
),
...
(
    NAME = WWI_UserData,
    FILENAME = '/var/opt/mssql/data/WideWorldImportersDW_UserData.ndf',
    SIZE = 2GB,
    MAXSIZE = UNLIMITED,
    FILEGROWTH = 64MB
)
...
(
    NAME = WWI_Log,
    FILENAME = '/var/opt/mssql/data/WideWorldImportersDW.ldf',
    SIZE = 100MB,
    MAXSIZE = UNLIMITED,
    FILEGROWTH = 64MB
)
